...
static NSString * const VAKInputNewNameGroup = @"Input new name group";
...
static NSString * const VAKNewTaskName = @"VAKNewTaskName";
static NSString * const VAKNewNotes = @"VAKNewtNotes";
static NSString * const VAKNewDate = @"VAKNewDate";
static NSString * const VAKNewPriority = @"VAKNewPriority";
